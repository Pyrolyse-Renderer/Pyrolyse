...
__host__ __device__ float4 operator*(const Maf44& M, float4 v);
...
__host__ __device__ float3 operator+(float3 a, float3 b);
__host__ __device__ float3 operator+(float3 f, float s);
...
__host__ __device__ float3 operator/(float3 f, float d);
